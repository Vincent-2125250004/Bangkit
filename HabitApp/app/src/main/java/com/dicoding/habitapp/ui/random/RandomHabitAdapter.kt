...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val ivItemLevel: ImageView = itemView.findViewById(R.id.item_priority_level)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            when (pageType) {
                PageType.HIGH -> ivItemLevel.setImageResource(R.drawable.ic_priority_high)
                PageType.MEDIUM -> ivItemLevel.setImageResource(R.drawable.ic_priority_medium)
                PageType.LOW -> ivItemLevel.setImageResource(R.drawable.ic_priority_low)
            }
