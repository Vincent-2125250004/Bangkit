...
class MainActivity : AppCompatActivity() {
    ...
    private var profileImageUrl ="https://dailyspin.id/wp-content/uploads/2023/07/honkai-star-rail-kafka-playable-tease-700x420.webp"
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarMain.fab.setOnClickListener {view ->
            Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG).setAction("Action"){
                Toast.makeText(this,"Halo ini action dari snackbar", Toast.LENGTH_SHORT).show()
            }.show()
        }
