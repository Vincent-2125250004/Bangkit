...
class CourseViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private var tvCourse = itemView.findViewById<TextView>(R.id.tv_course)
    private var tvTime = itemView.findViewById<TextView>(R.id.tv_time)
    private var tvLecturer = itemView.findViewById<TextView>(R.id.tv_lecturer)
