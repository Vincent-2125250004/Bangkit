...
class SeatsView : View {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        val heigthRowOne = (halfOfHeight - 600f)..(halfOfHeight - 400f)
        val heigthRowTwo = (halfOfHeight - 300f)..(halfOfHeight - 100f)
        val heigthRowThree = (halfOfHeight + 0f)..(halfOfHeight + 200f)
        val heigthRowFour = (halfOfHeight + 300f)..(halfOfHeight + 500f)

        if (event?.action == ACTION_DOWN) {
            when {
                event.x in widthColumnOne && event.y in heigthRowOne -> booking(0)
                event.x in widthColumnTwo && event.y in heigthRowOne -> booking(1)
                event.x in widthColumnOne && event.y in heigthRowTwo -> booking(2)
                event.x in widthColumnTwo && event.y in heigthRowTwo -> booking(3)
                event.x in widthColumnOne && event.y in heigthRowThree -> booking(4)
                event.x in widthColumnTwo && event.y in heigthRowThree -> booking(5)
                event.x in widthColumnOne && event.y in heigthRowFour -> booking(6)
                event.x in widthColumnTwo && event.y in heigthRowFour -> booking(7)
            }
        }
        return true
    }
